...
const BENCHMARK_LIBRARY: Record<string, BenchmarkEntry[]> = {
  FMCG: [
    ...
    { kpiName: 'Market Share', value: 15, unit: '%', topQuartile: 25, source: 'Kantar Worldpanel BrandFootprint 2024', sourceUrl: 'https://www.kantar.com/campaigns/brand-footprint', methodology: 'Average category leader share across FMCG categories in developed markets', confidence: 'High' },
    ...
    { kpiName: 'Inventory Turnover', value: 8, unit: 'x', topQuartile: 12, source: 'ASCM (APICS) SCOR Benchmark Database', sourceUrl: 'https://www.ascm.org/making-an-impact/research/', methodology: 'Median inventory turns for consumer goods sector from SCOR model', confidence: 'High' },
    { kpiName: 'Forecast Accuracy', value: 85, unit: '%', topQuartile: 92, source: 'Institute of Business Forecasting & Planning', sourceUrl: 'https://demand-planning.com/research/', methodology: 'Weighted MAPE-based forecast accuracy benchmark (IBF 2023 survey)', confidence: 'Medium' },
    { kpiName: 'Stockout Rate', value: 8, unit: '%', topQuartile: 3, source: 'ECR Community & IHL Group', sourceUrl: 'https://www.ecr-shrink-group.com/', methodology: 'On-shelf availability gap across European/NA retail (ECR 2023 report)', confidence: 'High' },
  ...
  Healthcare: [
    { kpiName: 'Readmission Rate', value: 15, unit: '%', topQuartile: 10, source: 'CMS Hospital Readmissions Reduction Program', sourceUrl: 'https://data.cms.gov/provider-data/topics/hospitals', methodology: '30-day all-cause readmission rate (CMS HRRP national avg)', confidence: 'High' },
    { kpiName: 'Average Length of Stay', value: 5.5, unit: 'days', topQuartile: 4.2, source: 'OECD Health Statistics 2024', sourceUrl: 'https://www.oecd.org/en/topics/health.html', methodology: 'Average inpatient length of stay across OECD nations (case-mix adjusted)', confidence: 'High' },
    ...
    { kpiName: 'Mortality Rate', value: 2.5, unit: '%', topQuartile: 1.5, source: 'CMS Hospital Compare', sourceUrl: 'https://data.cms.gov/provider-data/topics/hospitals', methodology: '30-day risk-standardized mortality for AMI, HF, pneumonia (combined)', confidence: 'High' },
    { kpiName: 'Operating Margin', value: 3.5, unit: '%', topQuartile: 8, source: 'Kaufman Hall National Hospital Flash Report', sourceUrl: 'https://www.kaufmanhall.com/insights/research-report/national-hospital-flash-report', methodology: 'Median operating margin for US hospitals (Kaufman Hall 2024 data)', confidence: 'High' },
    ...
    { kpiName: 'Staff Turnover', value: 22, unit: '%', topQuartile: 14, source: 'NSI National Health Care Retention & RN Staffing Report 2024', sourceUrl: 'https://www.nsinursingsolutions.com/Documents/Library/NSI_National_Health_Care_Retention_Report.pdf', methodology: 'Annualized hospital employee turnover rate (all staff)', confidence: 'High' },
  ...
  'Retail & E-commerce': [
    ...
    { kpiName: 'Conversion Rate', value: 2.5, unit: '%', topQuartile: 5, source: 'Adobe Digital Economy Index 2024', sourceUrl: 'https://business.adobe.com/resources/reports/digital-economy-index.html', methodology: 'Website visit to purchase conversion (US e-commerce, Adobe Analytics)', confidence: 'High' },
    { kpiName: 'Average Order Value', value: 75, unit: 'USD', topQuartile: 120, source: 'Adobe Digital Economy Index 2024', sourceUrl: 'https://business.adobe.com/resources/reports/digital-economy-index.html', methodology: 'Average online order value across US e-commerce transactions', confidence: 'Medium' },
    ...
    { kpiName: 'Revenue Per Square Foot', value: 400, unit: 'USD', topQuartile: 700, source: 'CoStar Group & ICSC Research', sourceUrl: 'https://www.icsc.com/news-and-views/research', methodology: 'Annual sales per sq ft for US shopping centers (CoStar 2024)', confidence: 'Medium' },
  ...
  Manufacturing: [
    ...
    { kpiName: 'On-Time Delivery', value: 85, unit: '%', topQuartile: 95, source: 'ASCM (APICS) Supply Chain Operations Reference (SCOR)', sourceUrl: 'https://www.ascm.org/making-an-impact/research/', methodology: 'Perfect order fulfillment rate (SCOR Level 1 metric)', confidence: 'High' },
